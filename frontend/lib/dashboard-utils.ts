...
export function calculateRiskLevel(scores: MentalHealthScore): AnalysisResult {
  ...
  const contributions: FeatureContribution[] = [
    { feature: 'Sleep', weight: (sleep / 12), impact: sleep > 7 ? 'positive' : 'negative' },
    { feature: 'Stress', weight: (stress / 100), impact: stress < 40 ? 'positive' : 'negative' },
    { feature: 'Activity', weight: (activity / 10), impact: activity > 5 ? 'positive' : 'negative' },
    { feature: 'Mood', weight: (mood / 10), impact: mood > 6 ? 'positive' : 'negative' },
    { feature: 'Hydration', weight: (hydration / 10), impact: hydration > 7 ? 'positive' : 'negative' },
    { feature: 'Screen Time', weight: (screenTime / 12), impact: screenTime < 5 ? 'positive' : 'negative' },
    { feature: 'Focus', weight: (focus / 10), impact: focus > 6 ? 'positive' : 'negative' },
  ];
